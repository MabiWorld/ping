$addrs = @{
	...
	"alexina" = @{
		"ch1" = @("52.32.149.152", 11020);
		"ch2" = @("52.32.149.152", 11021);
		"ch3" = @("52.32.149.152", 11022);
		"ch4" = @("52.34.200.191", 11020);
		"ch5" = @("52.34.200.191", 11021);
		"ch6" = @("52.34.200.191", 11022);
		"ch7" = @("52.34.200.191", 11023);
		"hch" = @("52.32.149.152", 11023);
	};
	"nao" = @{
		"ch1" = @("34.218.42.114", 11020);
		"ch2" = @("34.218.42.114", 11021);
		"ch3" = @("34.218.42.114", 11022);
		"ch4" = @("50.112.234.180", 11020);
		"ch5" = @("50.112.234.180", 11021);
		"ch6" = @("50.112.234.180", 11022);
		"ch7" = @("50.112.234.180", 11023);
		"ch8" = @("52.41.162.90", 11020);
		"ch9" = @("52.41.162.90", 11021);
		"ch10" = @("52.41.162.90", 11022);
		"hch" = @("34.218.42.114", 11023);
	};
}
